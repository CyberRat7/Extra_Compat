...
public class ForgottenGreatSwordItem extends GreatSwordItem {

    public ForgottenGreatSwordItem(Tier tier, int damage, float attackSpeed, Properties properties) {
