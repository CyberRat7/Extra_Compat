...
public class FroststeelQuarterstaffItem extends QuarterstaffItem {

    public FroststeelQuarterstaffItem(Tier tier, int damage, float attackSpeed, Properties properties) {
