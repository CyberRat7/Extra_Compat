...
public class ForgottenQuarterstaffItem extends QuarterstaffItem {

    public ForgottenQuarterstaffItem(Tier tier, int damage, float attackSpeed, Properties properties) {
