...
public class UtheriumQuarterstaffItem extends QuarterstaffItem {

    public UtheriumQuarterstaffItem(Tier tier, double damage, float attackSpeed, Properties properties) {
