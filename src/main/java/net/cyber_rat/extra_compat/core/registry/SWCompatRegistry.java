...
public class SWCompatRegistry {
    ...
    public static final RegistryObject<Item> REINFORCED_GREAT_PICKAXE = ExtraCompatItems.ITEMS.register("reinforced_gold_great_pickaxe",
            () -> new GreatPickaxeItem(ExtraCompatTiers.EXTRA_COMPAT_REINFORCED_GOLD, 6, -3.35F, (new Item.Properties().stacksTo(1))));
    public static final RegistryObject<CreativeModeTab> SW_COMPAT_TAB =
            CREATIVE_MODE_TABS.register("sw_compat_tab", () -> CreativeModeTab.builder().icon(() -> new ItemStack(SWCompatRegistry.
                ...
                output.accept(SWCompatRegistry.REINFORCED_GREAT_PICKAXE.get());
