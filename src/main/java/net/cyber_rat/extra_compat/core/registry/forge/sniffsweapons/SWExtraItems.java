...
public class SWExtraItems {
    ...
    public static final RegistryObject<? extends PickaxeItem> REINFORCED_GREAT_PICKAXE = ITEM_FACTORY.createGreatPickaxe("reinforced_gold_great_axe", ExtraCompatTiers.EXTRA_COMPAT_REINFORCED_GOLD,  6, -3.35F);
